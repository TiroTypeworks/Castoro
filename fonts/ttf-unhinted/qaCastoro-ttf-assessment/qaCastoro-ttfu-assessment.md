...
<details>
<summary><b>[17] Castoro Roman.ttf</b></summary>
<details>
...
* 🔥 **FAIL** Style name used in "Castoro Roman.ttf" is not canonical. You should rebuild the font using any of the following style names: "Thin", "ExtraLight", "Light", "Regular", "Medium", "SemiBold", "Bold", "ExtraBold", "Black", "Thin Italic", "ExtraLight Italic", "Light Italic", "Italic", "Medium Italic", "SemiBold Italic", "Bold Italic", "ExtraBold Italic", "Black Italic". [code: bad-static-filename]
...
* ⚠ **WARN** OS/2 xAvgCharWidth is 452 but it should be 559 which corresponds to the average of the widths of all glyphs in the font.
